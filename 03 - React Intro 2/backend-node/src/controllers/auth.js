...
exports.login = async (req, res) => {
    ...
    try {
        ...
        if (!isMatch) throw Error("I should not say that the pass does not match kek")
        ...
        if (!token) throw Error("Something critical happened 9901");

        res.status(200).json({token, ...userTemplate})
